...
public class ConfigBuilderV2 {
     ...
     */
    public ConfigBuilderV2(PackageConfig packageConfig, DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig,
    ...
    public ConfigBuilderV2 setTableInfoList(List<TableInfo> tableInfoList) {
    ...
    private void handlerPackage(TemplateConfig template, GlobalConfig globalConfig, PackageConfig config) {
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), globalConfig.getDaoOutputDir(), ConstVal.ENTITY_PATH, ConstVal.ENTITY);
            setPathInfo(pathInfo, template.getMapper(), globalConfig.getDaoOutputDir(), ConstVal.MAPPER_PATH, ConstVal.MAPPER);
            setPathInfo(pathInfo, template.getXml(), globalConfig.getDaoOutputDir(), ConstVal.XML_PATH, ConstVal.XML);
            setPathInfo(pathInfo, template.getService(), globalConfig.getServiceOutputDir(), ConstVal.SERVICE_PATH, ConstVal.SERVICE);
            setPathInfo(pathInfo, template.getServiceImpl(), globalConfig.getServiceOutputDir(), ConstVal.SERVICE_IMPL_PATH, ConstVal.SERVICE_IMPL);
            setPathInfo(pathInfo, template.getController(), globalConfig.getServiceOutputDir(), ConstVal.CONTROLLER_PATH, ConstVal.CONTROLLER);
        }
    }
    ...
    public ConfigBuilderV2 setStrategyConfig(StrategyConfig strategyConfig) {
        this.strategyConfig = strategyConfig;
        return this;
    }
    ...
    public ConfigBuilderV2 setGlobalConfig(GlobalConfig globalConfig) {
        this.globalConfig = globalConfig;
        return this;
    }
    ...
    public ConfigBuilderV2 setInjectionConfig(InjectionConfig injectionConfig) {
