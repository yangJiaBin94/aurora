...
public class AutoGenerator {
     ...
     * 配置信息
     */
    protected ConfigBuilderV2 config;
    /**
     * 注入配置
     */
    ...
    public void execute() {
        ...
        // 初始化配置
        if (null == config) {
            config = new ConfigBuilderV2(packageInfo, dataSource, strategy, template, globalConfig);
     ...
     * @return ignore
     */
    protected List<TableInfo> getAllTableInfoList(ConfigBuilderV2 config) {
     ...
     * @return 解析数据结果集
     */
    protected ConfigBuilderV2 pretreatmentConfigBuilder(ConfigBuilderV2 config) {
        /*
         * 注入自定义配置
         */
        if (null != injectionConfig) {
